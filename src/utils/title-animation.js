...
function fadeAnimation() {
    ...
    if ($(".tp_fade_anim").length > 0) {
        ...
        fadeArrayup.forEach((t, e) => {
            let r = "bottom", a = 1, o = 1, i = 50, s = .5, l = "power2.out";
...
export { heroTitleAnim, heroBgAnimation, bounceAnimation, fadeAnimation, charAnimation, revelAnimationTwo, revelAnimationOne, zoomAnimation, titleAnimation, };
