...
async function queryShopProducts(params: {
  category?: string; sub?: string; collection?: string; search?: string;
  minPrice?: number; maxPrice?: number; sort?: SortKey; page?: number; limit?: number;
}) {
...
type ShopSearchParams = {
  category?: string; sub?: string; collection?: string; sort?: string; price?: string; q?: string; page?: string;
};
