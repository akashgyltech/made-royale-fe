...
export function saveOrder(order) { write([order, ...read()]); }
export function getOrders() { return read(); }
export function getOrderByNumber(n) { return read().find((o) => o.orderNumber.toLowerCase() === n.toLowerCase()); }
export function computeStageIndex(order) {
