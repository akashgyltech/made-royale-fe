...
const HeaderMenus = ({ menu: menuProp }) => {
    const menuItems = menuProp ?? menu_data;
    return (<ul>
      {menuItems.map((menu) => (<li key={menu.id} className="has-dropdown">
          <Link href={menu.link}>{menu.title}</Link>
          {menu.home_menus ? (<div className="tp-submenu submenu tp-mega-menu">
              <div className="tp-menu-fullwidth">
                <div className="tp-homemenu-wrapper">
                  <div className="row gx-25 row-cols-xl-6 row-cols-lg-2 row-cols-md-2 row-cols-1">
                    {menu.home_menus.map((home_menu, i) => (<div key={i} className="col homemenu">
            ...
            </div>) : menu.pages_mega_menu ? (<div className="tp-submenu submenu tp-mega-menu">
                      ...
                      <div className="row gx-50">
                        <div className="col-xl-8">
                          <div className="tp-megamenu-list">
                            ...
                            <div className="tp-megamenu-list-wrap">
                              <ul>
                                {menu.pages_mega_menu.first.submenus.map((psm, i) => (<li key={i}>
                        ...
                        <div className="col-xl-4">
                          <div className="tp-megamenu-list tp-megamenu-list-2">
                            ...
                            <div className="tp-megamenu-list-wrap">
                              <ul>
                                {menu.pages_mega_menu.second.submenus.map((psm, i) => (<li key={i}>
                                      <Link href={psm.link}>{psm.title}</Link>
                                    </li>))}
                              </ul>
                            </div>
              ...
              <div className="tp-menu-fullwidth">
                <div className="tp-megamenu-portfolio p-relative">
                  <div className="tp-megamenu-portfolio-banner">
                    <Image style={{ width: "100%", height: "auto" }} src="/assets/img/menu/portfolio-menu/portfolio.png" alt="image" width={438} height={480}/>
                  </div>
                  <div className="row gx-50">
            ...
            </div>) : menu.dropdown_menus ? (<ul className="tp-submenu submenu">
