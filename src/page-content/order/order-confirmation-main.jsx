                ...
                <div className="mr-oc-grid">
                  <div className="mr-oc-panel">
                    ...
                    <div className="mr-oc-items">
                      {order.items.map((it) => (<div className="mr-oc-item" key={it.id}>
                    ...
                    <div className="mr-cart-summary-rows mr-oc-totals">
                      ...
                      {order.gstDetails.isInterState ? (<div className="mr-cart-summary-row"><span>IGST</span><span>{formatINR(order.pricing.igst)}</span></div>) : (<>
