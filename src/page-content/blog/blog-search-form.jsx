...
export default function BlogSearchForm({ initialSearch }) {
    ...
    return (<div className="tp-inner-header-2-search p-relative" style={{ maxWidth: 320 }}>
      <input type="text" placeholder="Search the Journal" value={term} onChange={(e) => setTerm(e.target.value)} onKeyDown={(e) => { if (e.key === "Enter")
        submit(); }}/>
