...
import { authorName, formatBlogDate, estimateReadTime, isHtmlContent } from "@/lib/blog-utils";
const BlogArticleMain = ({ blog, more }) => {
    const author = blog ? authorName(blog.author) : undefined;
    return (<Wrapper>
      <HeaderSix />
      <main className="mr-page-pt">
        {!blog ? (<div className="mr-shop-empty" style={{ padding: "100px 20px" }}><div className="mr-shop-empty-glyph">❖</div><h3>Article not found</h3><Link href="/blog" className="mr-btn-solid">Back to Journal</Link></div>) : (<article className="mr-article">
