...
export default function MissionOne() {
    return (<div className="tp-mission-area pt-120 pb-120 mb-110 black-bg p-relative">
        ...
        <div className="row">
          <div className="col-xl-6 col-lg-6 col-md-6">
            <div className="tp-mission-thumb">
              <Image data-speed=".8" src={m_img_1} alt="thumb-img" style={{ height: "auto" }}/>
            </div>
          </div>
          <div className="col-xl-6 col-lg-6 col-md-6">
            <div className="tp-mission-content">
              ...
              <div className="tp-hover-btn-wrapper tp_fade_bottom">
                <Link className="tp-btn-circle-2 tp-hover-btn-item tp-hover-btn" href="/about-us">
                  <span>
                    <UpArrow />
                    <br />
                    About us
      ...
      <div className="tp-mission-right-thumb">
        <Image data-speed=".9" src={m_img_2} alt="thumb-img" style={{ height: "auto" }}/>
      </div>
    </div>);
}
