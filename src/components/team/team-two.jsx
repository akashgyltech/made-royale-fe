...
export default function TeamTwo() {
    return (<div className="tp-team-4-area pt-120 pb-90" style={{ backgroundImage: "url(/assets/img/home-04/brand/overly.png)" }}>
        <div className="container">
          <div className="row">
            {team_data.map((item) => (<div key={item.id} className="col-xl-4 col-lg-6 col-md-6 mb-30">
                <div className="tp-team-4-item text-center tp_fade_bottom">
                    ...
                    <div className="tp-team-4-content">
                      ...
                      <div className="tp-team-4-social">
                        {item.socials.map((social, i) => (<Link key={i} href={social.link} target='_blank'>
