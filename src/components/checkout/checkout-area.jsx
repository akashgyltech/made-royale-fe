...
export default function CheckoutArea() {
    ...
    return (<section className="tp-checkout-area pt-200 pb-120">
      <div className="container">
            ...
            <div className="tp-checkout-verify">
              <div className="tp-checkout-verify-item">
                <p className="tp-checkout-verify-reveal">
                  Returning customer?{" "}
                  <button type="button" className="tp-checkout-login-form-reveal-btn" onClick={() => setOpenLogin(!openLogin)}>
                    Click here to login
                  </button>
                </p>

                {openLogin && (<div id="tpReturnCustomerLoginForm" className="tp-return-customer">
                    <form action="#">
              ...
              <div className="tp-checkout-verify-item">
                <p className="tp-checkout-verify-reveal">
                  Have a coupon?{" "}
                  <button type="button" className="tp-checkout-coupon-form-reveal-btn" onClick={() => setOpenCoupon(!openCoupon)}>
                    Click here to enter your code
                  </button>
                </p>

                {openCoupon && (<div id="tpCheckoutCouponForm" className="tp-return-customer">
                    <form action="#">
                      <div className="tp-return-customer-input">
        ...
        ]} defaultCurrent={0} onChange={(item) => handleCountry(item)} name="Country"/>
                        </div>
                      </div>
                      <div className="col-md-6">
                        <div className="tp-checkout-input">
