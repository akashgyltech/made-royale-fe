      ...
      <div className="sidebar__widget mb-65">
        ...
        <div className="sidebar__widget-content">
          <div className="sidebar__post rc__post">
            {rc_posts.map((item) => (<div key={item.id} className="rc__post mb-30 d-flex align-items-center">
                <div className="rc__post-thumb mr-20">
                  <Link href={`/blog-details/${item.id}`}>
                    <Image style={{ width: "auto", height: "auto" }} src={item.img} alt="blog-img" width={100} height={100}/>
                  </Link>
                </div>
