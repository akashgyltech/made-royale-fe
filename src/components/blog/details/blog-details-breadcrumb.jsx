...
export default function BlogDetailsBreadcrumb({ id }) {
    // Find the blog that matches the given ID
    const blog = blog_data.find((team) => team.id == id);
    return (<div className="blog-details-area">
      <div className="blog-details-bg blog-details-bg-height blog-details-overlay p-relative d-flex align-items-end pt-170 pb-170" style={{
