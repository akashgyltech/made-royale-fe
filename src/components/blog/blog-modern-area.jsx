...
export default function BlogModern() {
    ...
    const { currentItems, handlePageClick, pageCount } = usePagination(other_blogs, 6);
    return (<>
            ...
            <div className="col-xl-12">
              <div className="tp-blog-standard-thumb-box p-relative">
                ...
                <div className="tp-blog-standard-title-box d-none d-sm-block">
                  <h4 className="tp-blog-standard-title tp-char-animation" dangerouslySetInnerHTML={{ __html: first_blog.title }}></h4>
                </div>
      ...
      <div className="blog-details-realated-area pt-120 pb-70">
        <div className="container">
          <div className="row">
            {currentItems.map((item) => (<div key={item.id} className="col-xl-4 col-lg-6 col-md-6 mb-50">
                <BlogItem item={item}/>
              </div>))}
