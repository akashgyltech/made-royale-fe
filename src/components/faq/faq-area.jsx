...
export default function FaqArea({ faqs }) {
    const data = faqs && faqs.length > 0 ? faqs.map((f, i) => ({ id: i + 1, ...f })) : faq_data;
    return (<div className="fq-faq-area fq-faq-bdr pt-80 pb-140">
            ...
            <div className="fq-faq-wrapper">
              <div className="tp-service-2-accordion-box">
                <div className="accordion" id="accordionExample">
                  {data.map((item) => (<FaqItem key={item.id} item={item}/>))}
                </div>
              </div>
            </div>
          </div>
          <div className="col-xl-4 col-lg-4">
            <div className="fq-faq-sidebar">
              ...
              <div className="fq-faq-sidebar-thumb">
                <Image className="w-100" src={faq_banner} alt="faq-banner" style={{ height: 'auto' }}/>
              </div>
