...
// Hairline line-icon set for the storefront — a single, cohesive family that
// replaces stray emoji. All icons share a 24×24 viewBox, currentColor stroke and
// round joins, so they inherit size & colour from context (e.g. gold on the PDP).

export type IconName =
  | 'wood' | 'shield' | 'truck' | 'returns' | 'lock' | 'verified' | 'medal'
  | 'gem' | 'tag' | 'receipt' | 'ruler' | 'bank' | 'gift' | 'pin' | 'crown' | 'share';
