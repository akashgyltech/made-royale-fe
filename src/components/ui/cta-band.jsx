...
export default function CtaBand({ eyebrow, title, text, primaryLabel, primaryHref, secondaryLabel, secondaryHref }) {
    return (<section className="mr-cta-band">
      <div className="container container-1300">
        <div className="mr-cta-band-inner">
          ...
          <div className="mr-cta-band-actions">
            ...
            {secondaryLabel && secondaryHref && (<Link href={secondaryHref} className="mr-btn-outline mr-cta-band-ghost">{secondaryLabel}</Link>)}
          </div>
        </div>
      </div>
    </section>);
