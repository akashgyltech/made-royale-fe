...
export default function HeroBannerThree() {
    return (<div className="tp-hero-4-area tp-btn-trigger">
            ...
            <div className="tp-hero-4-content-wrap">
              <div className="p-relative">
                ...
                <div className="tp-hero-4-achievement tp-btn-bounce d-none d-md-block">
                  ...
                  <span>
                    <i data-purecounter-duration="1" data-purecounter-end="18" className="purecounter">
                      18
                    </i>
                    k
                  </span>
              ...
              <div className="tp-hero-4-thumb text-end">
                <Image style={{ width: "100%", height: "auto" }} priority data-speed=".7" src={hero_img} alt="hero-img"/>
              </div>
            </div>
          </div>
        </div>
