...
export default function HeroBannerSix() {
    ...
    return (<div className="tp-shop-slider-area p-relative">
      <div className="shop-slider-wrapper">
        <Swiper {...slider_setting} modules={[Navigation, Pagination, EffectFade]} className="swiper-container tp-shop-slider-active">
          {hero_data.map((item) => (<SwiperSlide key={item.id} className="swiper-slide">
              <div className="tp-shop-slider-bg tp-shop-slider-ovarlay">
                <div className="tp-shop-slider-thumb" data-background="assets/img/inner-shop/home/slider-1.jpg" style={{ backgroundImage: `url(${item.bg})` }}></div>
                    ...
                    <div className="col-xl-8">
                      <div className="tp-shop-slider-content z-index">
                        <div className="tp-shop-slider-title-box">
                          ...
                          <h2 className="tp-shop-slider-title" dangerouslySetInnerHTML={{ __html: item.title }}></h2>
                        </div>
