...
export default function ShopDetailsBottomArea() {
    ...
    return (<section className="tp-product-details-area">
              ...
              <div className="tp-product-details-tab-nav tp-tab">
                <nav>
                  <div className="nav nav-tabs justify-content-center p-relative tp-product-tab" id="navPresentationTab" role="tablist">
                    <button className="nav-link active" id="nav-description-tab" data-bs-toggle="tab" data-bs-target="#nav-description" type="button" role="tab" aria-controls="nav-description" aria-selected="true" tabIndex={0} ref={activeRef} onClick={(e) => handleActive(e)}>
                      Description
                    </button>
                    <button className="nav-link" id="nav-addInfo-tab" data-bs-toggle="tab" data-bs-target="#nav-addInfo" type="button" role="tab" aria-controls="nav-addInfo" aria-selected="false" tabIndex={-1} onClick={e => handleActive(e)}>
                      Size & Fit information
                    </button>
                    <button className="nav-link" id="nav-review-tab" data-bs-toggle="tab" data-bs-target="#nav-review" type="button" role="tab" aria-controls="nav-review" aria-selected="false" tabIndex={-1} onClick={e => handleActive(e)}>
                      Reviews (2)
                    </button>

                    <span id="productTabMarker" className="tp-product-details-tab-line" ref={marker}></span>
                  </div>
                </nav>
                <div className="tab-content" id="navPresentationTabContent">
                  ...
                  <div className="tab-pane fade" id="nav-addInfo" role="tabpanel" aria-labelledby="nav-addInfo-tab" tabIndex={0}>
                    {/* details sizes */}
                    <DetailsSizes />
                    {/* details sizes */}
                  </div>
