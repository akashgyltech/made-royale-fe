...
export default function ProductModal({ show, onClose, product }) {
    ...
    return (<Modal show={show} onHide={onClose} centered className="tp-product-modal mr-qv">
        ...
        <div className="tp-product-modal-content d-lg-flex align-items-start">
          <div className="mr-qv-gallery d-sm-flex">
            <div className="mr-qv-thumbs">
              {gallery.map((g, i) => (<button key={i} className={`mr-qv-thumb ${active === i ? "active" : ""}`} type="button" onClick={() => setActive(i)} aria-label={`View ${i + 1}`}>
          ...
          <div className="tp-product-details-wrapper mr-qv-info">
            ...
            {product.colors.length > 0 && (<div className="mb-20">
