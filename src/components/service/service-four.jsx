...
export default function ServiceFour() {
    return (<div className="tp-service-3-area pt-130 pb-130">
      <div className="container">
        ...
        {service_data.map((item) => (<div key={item.id} className="tp-service-3-wrap tp_fade_bottom">
              ...
              <div className="col-xl-7 col-lg-7">
                <div className="tp-service-3-content">
                  ...
                  <div className="tp-service-3-category">
                    {item.category.map((c, i) => (<span key={i}>{c}</span>))}
                  </div>
                </div>
              </div>
