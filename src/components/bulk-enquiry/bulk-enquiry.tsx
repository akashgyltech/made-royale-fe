...
type Form = { name: string; company: string; email: string; phone: string; city: string; requirement: string; quantity: string; message: string };
const EMPTY: Form = { name: '', company: '', email: '', phone: '', city: '', requirement: REQUIREMENTS[0], quantity: '', message: '' };
        ...
        <div className="mr-bulk-layout">
          ...
          <aside className="mr-bulk-aside">
            <div className="mr-bulk-benefits">
              ...
              {BENEFITS.map((b) => (
                <div key={b.title} className="mr-bulk-benefit">
