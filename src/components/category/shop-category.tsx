...
export default function ShopCategory({ categories }: { categories: Category[] }) {
  return (
      ...
      <div className="container container-1400">
        ...
        {categories.length > 0 ? (
          <div className="mr-cats-grid">
            {categories.map((item) => (
              <Link key={item.id} href={`/category/${item.slug}`} className="mr-cat-card">
          ...
          <p className="mr-catproducts-empty">Categories are being curated — check back soon.</p>
        )}
