...
export default function CategoryLanding({ category, featuredProducts, totalInCategory, priceFrom, subCategoryCounts, otherCategories, otherCategoryCounts = {} }) {
    ...
    return (<>
      ...
      <section className="mr-cathero">
        ...
        <img src={category.banner} alt="" loading="eager"/>) : category.image ? (
        // eslint-disable-next-line @next/next/no-img-element
        <img src={category.image} alt="" loading="eager"/>) : (<span className="mr-cathero-fallback"/>)}
      ...
      {category.subcategories.length > 0 && (<section className="mr-subcat">
          <div className="container container-1400">
            ...
            <div className="mr-subcat-grid">
              {category.subcategories.map((s) => {
                ...
                return (<Link key={s.id} href={`/shop?category=${category.slug}&sub=${s.slug}`} className="mr-subcat-card">
      ...
      <section className="mr-catproducts">
        <div className="container container-1500">
          ...
          {featuredProducts.length > 0 ? (<div className="mr-grid mr-grid-4">{featuredProducts.map((p) => <ShopItem key={p.id} product={p}/>)}</div>) : (<p className="mr-catproducts-empty">New pieces in this category are arriving soon — explore the full collection meanwhile.</p>)}
      ...
      <section className="mr-catfeatures">
        <div className="container container-1400">
          ...
          <div className="mr-catfeatures-grid">
            {copy.features.map((f) => (<div key={f.title} className="mr-catfeature">
      ...
      <CtaBand eyebrow="Bespoke Interiors" title="Not sure what fits your space?" text="Share your room dimensions and style, and our design consultants will curate a personalised selection — free of charge." primaryLabel="Book a Free Consultation" primaryHref="/contact" secondaryLabel="Shop All Furniture" secondaryHref="/shop"/>
    </>);
}
