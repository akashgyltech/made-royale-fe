  ...
  return (
    <>
      ...
      <section className="mr-catother">
        <div className="container container-1400">
          ...
          <div className="mr-catother-grid">
            {others.map((c) => (
              <Link key={c.id} href={`/collection/${c.slug}`} className="mr-cat-card">
      ...
      <CtaBand
        ...
        title={`Bring the ${collection.name} look home`}
        text="Share your room dimensions and style, and our design consultants will curate a personalised selection from this collection — free of charge."
