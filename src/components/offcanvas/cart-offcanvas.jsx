...
export default function CartOffcanvas(_props) {
    ...
    return (<>
      <div className={`mr-drawer ${isDrawerOpen ? "is-open" : ""}`} role="dialog" aria-label="Shopping cart">
        ...
        {count > 0 && (<div className="mr-drawer-ship">
        ...
        <div className="mr-drawer-body">
          {count === 0 ? (<div className="mr-drawer-empty">
            ...
            </div>) : (resolved.map((line) => (<div className="mr-drawer-item" key={line.key}>
        ...
        {count > 0 && (<div className="mr-drawer-foot">
